    ...
    for letter in charsToDisplay:
        ...
        for column in range(0, 8):
            for row in range(0, 8):
                dataToWrite[row] = int((amstradCharMap[lastLetter][row])/2**(column+1)) + int((amstradCharMap[asciiVal][row])*2**(7-column))
                dataToWrite[row] = dataToWrite[row] % 256
